...
from .models import BuyerProfile, DriverProfile, ArtisanProfile, WasteSellerProfile
...
class WasteSellerProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = WasteSellerProfile
        fields = ['profile_picture', 'company_name', 'business_type', 'location']
        widgets = {
