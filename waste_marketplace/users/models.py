...
# Waste Seller-specific data
class WasteSellerProfile(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE)
    company_name = models.CharField(max_length=255, blank=True)
    business_type = models.CharField(max_length=100, blank=True)  # Factory, Household, Business, Institution
    ...
    def __str__(self):
        return f"WasteSellerProfile - {self.user.username}"
