...
graph TD
    ...
    F --> G[Delivery scheduled]
    G --> H[Driver collects waste]
    H --> I[Waste delivered to artisan]
```
...
graph TD
    ...
    J --> K[Creative upcycling process]
    K --> L[Quality control checks]
    L --> M[Finished product photographed]
    M --> N[Product listed for sale]
```
...
graph TD
    ...
    Q --> R[Driver delivers product]
    R --> S[Buyer receives and reviews]
```
